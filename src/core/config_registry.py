...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "NEWS_INTEL_AUTO_FETCH_ENABLED": {
        ...
        "description": "Automatically seed the built-in free RSS/NewsNow intelligence sources and periodically fetch them in the background, independent of SCHEDULE_ENABLED. Disable to stop all outbound requests to these free sources.",
        "category": "data_source",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
        ...
        "validation": {},
        "display_order": 62,
        "help_key": "settings.data_source.news_intel_auto_fetch",
        "examples": [
            "NEWS_INTEL_AUTO_FETCH_ENABLED=true",
            "NEWS_INTEL_AUTO_FETCH_INTERVAL_MINUTES=20",
        ],
        "docs": [
            {
                "label": "完整指南：环境变量完整列表",
    ...
    "NEWS_INTEL_AUTO_FETCH_INTERVAL_MINUTES": {
        "title": "Free RSS/NewsNow Fetch Interval (Minutes)",
        "description": "How often the background loop fetches the enabled free RSS/NewsNow sources. Only takes effect when NEWS_INTEL_AUTO_FETCH_ENABLED is true.",
        "category": "data_source",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "MARKET_REVIEW_REGION": {
        ...
        "description": "Market region for review: cn (A-shares), hk (Hong Kong), us (US stocks), jp (Japan), kr (Korea), tw (Taiwan), or both (all markets).",
        "category": "system",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        ...
        "is_editable": True,
        "default_value": "cn",
        "options": ["cn", "hk", "us", "jp", "kr", "tw", "both"],
        "validation": {"allowed_values": ["cn", "hk", "us", "jp", "kr", "tw", "both"], "delimiter": ","},
        "display_order": 48,
        "help_key": "settings.system.market_review",
        "examples": [
            "MARKET_REVIEW_REGION=cn",
