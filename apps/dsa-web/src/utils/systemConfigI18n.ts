...
const fieldTitleMap: Record<string, string> = {
  ...
  NEWS_INTEL_AUTO_FETCH_ENABLED: '免费 RSS/NewsNow 自动拉取',
  NEWS_INTEL_AUTO_FETCH_INTERVAL_MINUTES: '免费资讯源拉取间隔（分钟）',
  NEWS_CLAUDE_SEARCH_ENABLED: 'Claude WebSearch 新闻兜底',
...
const fieldDescriptionMap: Record<string, string> = {
  ...
  NEWS_INTEL_AUTO_FETCH_ENABLED: '启用后台自动补种并定时拉取内建免费 RSS/NewsNow 资讯源，与 SCHEDULE_ENABLED（每日分析定时任务）无关，独立运作。',
  NEWS_INTEL_AUTO_FETCH_INTERVAL_MINUTES: '自动拉取免费资讯源的间隔时间（分钟），仅在 NEWS_INTEL_AUTO_FETCH_ENABLED=true 时生效。',
  NEWS_CLAUDE_SEARCH_ENABLED: '无搜索引擎可用时，用窄范围 Claude WebSearch（仅此工具）补个股新闻；会消耗 Claude 用量，默认关闭。',
  ...
  MARKET_REVIEW_REGION: '大盘复盘默认市场区域（如 cn/hk/us/jp/kr/tw/both），支持逗号分隔子集，如 `cn,us,jp`。',
